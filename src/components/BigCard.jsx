function BigCard({ socialCard, arrow }) {
  ...
  return (
      ...
      <div className="relative flex flex-col justify-center items-center gap-6 w-84 md:w-78 lg:w-64 p-6 rounded-lg bg-light2 text-light3 hover:-translate-y-1 hover:cursor-pointer hover:bg-lightHover dark:hover:bg-darkHover font-bold transition-all duration-500 ease-in-out dark:bg-dark3 dark:text-dark4">
